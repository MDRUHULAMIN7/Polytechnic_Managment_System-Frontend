...
import type { SemesterEnrollmentStudentPageProps } from "@/lib/type/dashboard/admin/semester-enrollment/ui";
...
export function SemesterEnrollmentPage({
  ...
  curriculums,
  error,
}: SemesterEnrollmentStudentPageProps) {
  ...
  return (
    <section className="space-y-5">
      ...
      <SemesterEnrollmentTable
        ...
        loading={isPending}
        error={error}
        basePath="/dashboard/student/semester-enrollments"
        showView
        viewLabel="View"
        actionsLabel="View"
      />
