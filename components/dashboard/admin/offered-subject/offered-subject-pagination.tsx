import type { OfferedSubjectPaginationProps } from "@/lib/type/dashboard/admin/offered-subject/ui";

export function OfferedSubjectPagination({
  meta,
  page,
  limit,
  onPageChange,
  onLimitChange,
}: OfferedSubjectPaginationProps) {
