...
import type { PeriodConfigModalProps } from "@/lib/type/dashboard/admin/period-config/ui";
    ...
    <AnimatePresence>
      {open ? (
        <>
          ...
          >
            <section
              className="flex max-h-full w-full max-w-4xl flex-col rounded-2xl border border-(--line) bg-(--surface) shadow-[0_24px_48px_rgba(15,23,42,0.2)]"
