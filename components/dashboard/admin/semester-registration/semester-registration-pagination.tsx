import type { SemesterRegistrationPaginationProps } from "@/lib/type/dashboard/admin/semester-registration/ui";

export function SemesterRegistrationPagination({
  meta,
  page,
  limit,
  onPageChange,
  onLimitChange,
}: SemesterRegistrationPaginationProps) {
