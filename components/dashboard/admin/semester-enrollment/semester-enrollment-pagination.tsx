import type { SemesterEnrollmentPaginationProps } from "@/lib/type/dashboard/admin/semester-enrollment/ui";

export function SemesterEnrollmentPagination({
  meta,
  page,
  limit,
  onPageChange,
  onLimitChange,
}: SemesterEnrollmentPaginationProps) {
