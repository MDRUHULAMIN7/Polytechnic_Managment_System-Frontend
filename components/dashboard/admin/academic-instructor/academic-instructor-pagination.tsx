import type { AcademicInstructorPaginationProps } from "@/lib/type/dashboard/admin/academic-instructor/ui";

export function AcademicInstructorPagination({
  meta,
  page,
  limit,
  onPageChange,
  onLimitChange,
}: AcademicInstructorPaginationProps) {
