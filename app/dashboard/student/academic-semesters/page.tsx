...
import { AcademicSemesterPageServer } from "@/components/dashboard/student/academic-semester/academic-semester-server";
...
export default async function AcademicSemestersPage({ searchParams }: PageProps) {
