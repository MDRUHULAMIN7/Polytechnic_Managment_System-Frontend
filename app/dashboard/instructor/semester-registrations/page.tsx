...
import { SemesterRegistrationPageServer } from "@/components/dashboard/instructor/semester-registration/semester-registration-server";
import type {
...
export default async function SemesterRegistrationsPage({
  searchParams,
}: PageProps) {
