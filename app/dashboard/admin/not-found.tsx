...
export default function AdminNotFoundPage() {
  return (
    <section className="mx-auto mt-10 max-w-3xl rounded-2xl border border-(--line) bg-(--surface) p-8 text-center">
      <p className="text-xs font-semibold uppercase tracking-[0.14em] text-(--primary)">Dashboard Admin</p>
      <h1 className="mt-2 text-3xl font-semibold tracking-tight text-(--text)">Admin Page Not Found</h1>
      <p className="mt-3 text-sm leading-6 text-(--text-dim)">
        This admin route does not exist yet or may have been moved.
      </p>
      <Link
